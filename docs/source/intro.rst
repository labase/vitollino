...
.. raw:: html
    ...
    <table border="0" cellpadding="10" cellspacing="1" height="50" width="100%">
        <tbody>
            <tr>
                <td style="background-color: rgb(0, 204, 255);"><span style="font-size:24px;">Engenho de Games para Ensino de Programa&ccedil;&atilde;o</span></td>
                <td style="text-align: right;"><em><span style="font-size:24px;">LABASE </span></em></td>
                <td style="text-align: right; width: 45px"><a href="http://labase.selfip.org"><img alt="" src="https://s19.postimg.org/us98poo43/labaselegon.png" style="width: 50px; height: 37px;" /></a></td>
            </tr>
        </tbody>
    </table>
    ...
    <p>Vitollino &eacute; um engenho para constru&ccedil;&atilde;o de jogos inteligentes para ensino de programa&ccedil;&atilde;o ou qualquer outro asunto que possa ser ensinado por games.</p>
    ...
    <p>O engenho Vitollino &eacute; baseado no Phaser e &eacute; programado em <a class="reference external" href="http://www.brython.info">Brython</a></p>
    ...
    <table border="0" cellpadding="1" cellspacing="0" style="border: 1px solid gray; width: 100%;">
        <tbody>
            <tr>
                ...
                <td style="border: 1px solid gray; background-color: white;">&nbsp;<a href="https://github.com/labase/vitollino">Github</a></td>
            </tr>
            <tr>
                <td style="border: 1px solid gray; background-color: rgb(153, 204, 255);"><strong>&nbsp; Registro de Tiquets</strong></td>
                <td style="border: 1px solid gray; background-color: white;">&nbsp;<a href="https://github.com/labase/vitollino/issues">Github-Issues</a></td>
            </tr>
        </tbody>
    </table>
    </div>
    ...
    <table border="0" cellpadding="1" cellspacing="0" style="border: 1px solid gray; width: 100%;">
        <tbody>
            <tr>
                <td style="border: 1px solid gray; background-color: rgb(153, 204, 255);"><strong>&nbsp; Atividades em Waffle.io</strong></td>
                <td style="border: 1px solid gray; background-color: white; text-align: center;">&nbsp;<a href="http://waffle.io/labase/vitollino"><img alt="Stories in Ready" src="https://badge.waffle.io/labase/vitollino.svg?label=ready&amp;title=Ready" style="max-width: 100%; width: 70px; height: 18px;" /></a></td>
            </tr>
            <tr>
                <td style="border: 1px solid gray; background-color: rgb(153, 204, 255);"><strong>&nbsp; Integra&ccedil;&atilde;o em Codeship</strong></td>
                <td style="border: 1px solid gray; background-color: white; text-align: center;">&nbsp;<a href="https://codeship.com/projects/142015"><img alt="Build Status" src="https://codeship.com/projects/d29b88d0-d312-0133-315e-6af7e052eb76/status?branch=master" style="max-width: 100%; width: 80px; height: 18px;" /></a></td>
            </tr>
            <tr>
                <td style="border: 1px solid gray; background-color: rgb(153, 204, 255);"><strong>&nbsp; Manual em Read the Docs</strong></td>
                <td style="border: 1px solid gray; background-color: white; text-align: center;">&nbsp;<a href="http://vitollino.readthedocs.org/"><img alt="Document Build Status" src="https://readthedocs.org/projects/vitollino/badge/?version=latest" style="max-width: 100%; width: 76px; height: 20px;" /></a></td>
            </tr>
        </tbody>
    </table>
    ...
    <p><img alt="" src="https://graphs.waffle.io/labase/vitollino/throughput.svg" style="width: 370px; height: 121px;" /></p>
    </div>

    <p style="text-align: center;">Copyleft 2016 Carlo E. T. Oliveira</p>
    </div>
